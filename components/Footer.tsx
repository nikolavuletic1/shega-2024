...
const Footer = () => {
  ...
  // Scroll effect on component mount
  useLayoutEffect(() => {
  ...
  return (
    <div id="/contact" className="flex flex-1 bg-blue-20 justify-center flex-col w-full h-full relative ">
      ...
      <AnimateInView animationClass="animate-zoom-in-from-zero text-[2.2rem] font-bold leading-none xs:text-5xl sm:text-6xl md:text-5xl lg:text-6xl xxl:text-7xl mb-8 mt-6 px-4 text-yellow-20 mx-auto text-center z-10"
        style={{
      ...
      <div className="flex flex-col flex-1 lg:flex-row justify-evenly w-[90%] h-3/4 mx-auto relative">
        {/* Form section */}
        <AnimateInView animationClass=" animate-fade-in-left border-8 border-blue-70 w-[95%] mx-auto lg:w-[65%] p-3 md:h-[24rem] rounded-3xl">
          <form
