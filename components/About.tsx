...
export default function About() {
  ...
  return (
    ...
    <div
      ...
      flex flex-col justify-center mt-[0rem] xl:mt-[0rem] lg:mt-[0rem] md:mt-[0rem] sm:mt-[0rem] w-full  min-h-screen'>
      <RedBgPattern />
      <div 
      className="flex flex-col items-center justify-evenly relative sm:flex-col md:flex-row lg:flex-row h-full">
        ...
        <motion.div
          ...
          className='rounded-full w-[96%] xxl:min-w-[32%] xxl:max-w-[32%] flex order-1 lg:min-w-[45%] lg:max-w-[45%] md:min-w-[48%] md:max-w-[48%] 
          sm:min-w-[80%] sm:max-w-[80%] xs:min-w-[90%] xs:max-w-[90%] bg-yellow-500 overflow-hidden border-4 h-full '
          style={{
            boxShadow: `
      ...
      `,
        ...
        <div className="text-center mt-4 md:order-1 h-full">
