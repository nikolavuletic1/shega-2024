          ...
          <div className="flex flex-col w-[95%] xl:min-w-[45%] xl:max-w-[45%] lg:min-w-[40%] lg:max-w-[40%] md:min-w-[45%] md:max-w-[45%] sm:min-w-[75%] sm:max-w-[75%] xs:min-w-[90%] xs:max-w-[90%]">
            ...
            <Link href="/">
              <Image
                ...
                className="animate-fade-in-left mx-auto w-full h-[8rem]  xs:w-[30rem] xs:h-[11rem] sm:w-[27rem] sm:h-[9rem] md:w-[30rem] md:h-[15rem] lg:w-[36rem] lg:h-[18rem] xl:w-[36rem] xl:h-[20rem] xxl:w-[50rem] xxl:h-[30rem] object-cover"
